export default {
  ...
  contextMenu: {
    ...
    generateSelect: 'SELECT * FROM ...',
    generateSelectCount: 'SELECT COUNT(*)',
    generateInsert: 'INSERT INTO ...',
    generateDrop: 'DROP ...',
    generateCall: 'CALL / SELECT ...()',
    generateSelectColumn: 'SELECT column',
    useDatabase: 'USE Database',
    setSearchPath: 'SET search_path',
    copyName: 'Copy Name',
